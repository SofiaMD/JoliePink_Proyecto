    ...
    useEffect(() => {
      ...
      return(
            ...
            <View style={styles.container}>
                <Text>{shoppingCartState.currentCart.nombre}</Text>
                <Text>{shoppingCartState.currentCart.precio}</Text>
                <Text>{shoppingCartState.currentCart.talla}</Text>
                <Text>{shoppingCartState.currentCart.color}</Text>
